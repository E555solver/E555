...
| tier | tool | one-liner |
|---|---|---|
| flagship | **`E555_beamer`** (C, OpenMP) | Wide beam over the 5-5-5 chain database; fail-fast sweep over border configurations; the **Mahalanobis color-usage heuristic** (`--lambda_Mahalanobis`) rewards atypical color consumption and is the project's main original contribution. |
